...
const Footer = () => {
    return (
        <footer className="bg-gray-100 text-black lg:h-64 border border-black">
            <div className="sm:w-[90%] w-[94%] m-auto">
                <div className="lg:flex justify-between">
                <div className="my-2 lg:mb-0 border border-gray-100 lg:h-40 lg:w-[31%]">
                ...
                <div className="my-2 border border-gray-100 lg:w-[31%] lg:h-[249px]">
                    ...
                    <form className="font-oxanium font-extrabold text-[13px] tracking-wider " action="">
                        <label htmlFor="email">
                            <input className="bg-slate-100 border border-gray-100 border-dashed border-b-black p-2 w-[100%] text-black focus:outline-none" type="email" placeholder="Enter your email address"/>
                        </label>
                    </form>
                    <p className="font-oxanium text-[6px] mt-6 lg:mt-[130px] lg:mb-[2px] text-black tracking-[0.15rem]">WEBSITE  BY  SENGA EMMANUEL KABARE</p>
                </div>
                <div className="border border-gray-100 lg:h-40 lg:w-[31%]">
            ...
            <div className="m-auto w-[80%] lg:w-48 lg:h-24 lg:ml-0 text-center lg:relative bottom-28">
