            ...
            <div className="sm:flex justify-between ">
                ...
                <div className="sm:flex justify-between my-4">
                    ...
                    <ul className="sm:w-[55%] sm:ml-28">
                        ...
                        <h1 className="sm:ml-4 font-antic font-extrabold text-2xl tracking-tightest mb-2 mt-4"><span className="font-oxanium-thin font-light text-xl text-gray-600 mx-2" >01</span>Responsive Design</h1> 
                        </li>
                        <li className="sm:ml-10 border-b-2 border-black">
                        <h1 className="sm:ml-4 font-antic font-extrabold text-2xl tracking-tightest my-2"><span className="font-oxanium-thin font-light text-xl text-gray-600 mx-2" >02</span>Responsive Design</h1>  
                        </li>
                        <li className="sm:ml-10">
                        <h1 className="sm:ml-4 font-antic font-extrabold text-2xl tracking-tightest my-2"><span className="font-oxanium-thin font-light text-xl text-gray-600 mx-2" >03</span>Responsive Design</h1>
                        </li>
                    </ul> 
                </div> 
        </div>
